...
Array.prototype.firstOrDefault = function(this: any[]): any | null {
  return this[0] != undefined ? this[0] : null;
}

Array.prototype.lastOrDefault = function(this: any[]): any | null {
  return this[this.length-1] != undefined ? this[this.length-1] : null;
}

Array.prototype.exclude = function(this: any[], ...no: any[]): any[] {
  let ret: any[] = [];
...
Array.prototype.removeAt = function(this: any[], index: number): any[] {
  let ret: any[] = [];
...
Array.prototype.limit = function(this: any[], cap: number, inv: boolean = false): any[] {
  if(cap == 0)
  {
    return this;
  }
